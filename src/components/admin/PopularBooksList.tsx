...
const POPULAR_BOOKS = [
  ...
  },
  {
    ...
    language: "nepali" as const,
    isNew: true,
    sellerReview: "Brand new copy. A charming coming-of-age story that resonates with young adults.",
    sellerName: "Kabir KC",
    rating: 4
  },
  {
    ...
    language: "english" as const,
    isNew: true,
    sellerReview: "Fresh from the publisher, special edition with beautiful cover art. A timeless classic.",
  ...
  },
  {
    ...
    language: "nepali" as const,
    isNew: true,
    sellerReview: "New release, first edition. A moving father-son story that captures rural Nepali life perfectly.",
  ...
  },
  {
    ...
    language: "english" as const,
    isNew: true,
    sellerReview: "Brand new collector's edition. The beginning of the magical journey that captured millions.",
  ...
  },
  {
    ...
    language: "nepali" as const,
    isNew: true,
    sellerReview: "New printing, mint condition. A powerful novel exploring psychological themes in a Nepali context.",
    sellerName: "Sarita Tamang",
    rating: 4
  }
];

export function PopularBooksList({ bookType = "all" }: PopularBooksListProps) {
  // Filter books based on type
  const filteredBooks = bookType === "all" 
    ? POPULAR_BOOKS 
    : POPULAR_BOOKS.filter(book => bookType === "new" ? book.isNew : !book.isNew);
